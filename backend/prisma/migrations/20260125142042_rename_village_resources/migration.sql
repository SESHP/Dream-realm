/*
  ...
  - You are about to drop the column `frozen_wishes` on the `villages` table. All the data in the column will be lost.
  - You are about to drop the column `nightmare_shards` on the `villages` table. All the data in the column will be lost.
  - You are about to drop the column `oblivion_essence` on the `villages` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "villages" DROP COLUMN "frozen_wishes",
...
ALTER COLUMN "max_storage" SET DEFAULT 100;
